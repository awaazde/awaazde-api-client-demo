...
public class TemplatesDataManager extends DataManager { 
	...
	private static final String CALL_METHOD_NAME = "templates";
	//requester
	...
	public Map<String, Object> create(Map<String, Object> objectData) throws XACTDataException {
		throw new UnsupportedOperationException("Creating of new template through web service is not available for now");
	}

	@Override
	public Map<String, Object> modify(String objectId, Map<String, Object> objectData) throws XACTDataException {
		throw new UnsupportedOperationException("Editing of template through web service is not available for now");	}

	@Override
	public boolean delete(String objectId) throws XACTDataException {
		throw new UnsupportedOperationException("Deleting of template through web service is not available for now");
	}
}
